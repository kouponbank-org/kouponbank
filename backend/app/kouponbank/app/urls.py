...
urlpatterns = [
   ...
   path('owners/<uuid:owner_id>/business/<uuid:business_id>/table/<uuid:table_id>/reservation/<uuid:reservation_id>/timeslot/', TableTimeslotListAPI.as_view(), name="timeslot-list"),
   path('owners/<uuid:owner_id>/business/<uuid:business_id>/table/<uuid:table_id>/reservation/<uuid:reservation_id>/timeslot/<uuid:timeslot_id>', TableTimeslotAPI.as_view(), name="timeslot"),
